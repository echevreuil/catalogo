...
CREATE TABLE `comentario` (
  ...
  `id_tipo_comentario` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_comentario`),
  KEY `fk_comentario_usario_idx` (`id_usuario`),
  KEY `fk_comentario_pai_idx` (`id_comentario_pai`),
  KEY `fk_comentario_1_idx` (`id_tipo_comentario`),
  CONSTRAINT `fk_comentario_tipo_comentario` FOREIGN KEY (`id_tipo_comentario`) REFERENCES `tipo_comentario` (`id_tipo_comentario`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
LOCK TABLES `tipo_comentario` WRITE;
...
-- Dump completed on 2014-11-23 21:14:21
